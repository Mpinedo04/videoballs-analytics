        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <header className="flex items-center justify-between mb-8">
            ...
            <div className="hidden md:flex items-center gap-3">
              <a 
                href="https://www.tiktok.com/auth/authorize?client_key=awaqs7lts147lb27&scope=user.info.basic,video.list,user.info.stats&response_type=code&redirect_uri=https://videoballs-analyticsraulmiguel2.vercel.app/api/auth/callback/tiktok"
