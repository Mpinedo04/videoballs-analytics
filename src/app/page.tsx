        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <header className="flex items-center justify-between mb-8">
            ...
            <div className="hidden md:flex items-center gap-3">
              <a 
                href="https://www.tiktok.com/v2/auth/authorize/?client_key=sbaw8oawxu1kbnrnel&scope=user.info.basic,user.info.profile,user.info.stats,video.list&response_type=code&redirect_uri=https%3A%2F%2Fvideoballs-analyticsraulmiguel2.vercel.app%2Fapi%2Fauth%2Fcallback%2Ftiktok&state=vballs_auth_state_777"
